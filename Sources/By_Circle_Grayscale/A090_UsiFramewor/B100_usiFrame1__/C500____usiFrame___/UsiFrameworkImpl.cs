...
namespace Grayscale.A090_UsiFramewor.B100_usiFrame1__.C500____usiFrame___
{
    public class UsiFrameworkImpl : UsiFramework
    {
        ...
        System.Diagnostics.Debugger.Break();
                    ...
                    //************************************************************************************************************************
                    this.OnLoop1Begin();
                    PhaseResult_Usi_Loop1 result_Usi_Loop1 = this.executeLoop1Body();
                    this.OnLoop1End();

                    if (result_Usi_Loop1 == PhaseResult_Usi_Loop1.TimeoutShutdown)
                    {
                        //MessageBox.Show("ループ１で矯正終了するんだぜ☆！");
                        return;//全体ループを抜けます。
                    }
                    else if (result_Usi_Loop1 == PhaseResult_Usi_Loop1.Quit)
                    {
                        return;//全体ループを抜けます。
                    }
        ...
        public PhaseResult_Usi_Loop1 executeLoop1Body()
        {
            //
            ...
            PhaseResult_Usi_Loop1 result_Usi_Loop1 = PhaseResult_Usi_Loop1.None;
            ...
            while (true)
            {
                ...
                {
                    case PhaseResult_Usi_Loop1.Break:
                        goto end_loop1;

                    case PhaseResult_Usi_Loop1.Quit:
                        goto end_loop1;
        ...
        public void executeLoop2Body()
        {
            while (true)
            {
                ...
                PhaseResult_Usi_Loop2 result_Usi_Loop2;
                {
                    result_Usi_Loop2 = PhaseResult_Usi_Loop2.None;
                ...
                {
                    case PhaseResult_Usi_Loop2.Break:
                        goto end_loop2;
