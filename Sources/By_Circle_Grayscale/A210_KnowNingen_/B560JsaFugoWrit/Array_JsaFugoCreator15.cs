...
namespace Grayscale.A210KnowNingen.B560_JsaFugoWrit.C500Writer
{
    ...
    {
        public delegate JsaFugoImpl DELEGATE_CreateJFugo(Move move, ISky kWrap, KwLogger errH);
        ...
        public static JsaFugoImpl CreateNullKoma(Move move, ISky kWrap, KwLogger errH)
        {
            JsaFugoImpl result;
        ...
        /// <returns></returns>
        public static JsaFugoImpl CreateFu(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl result;
        ...
        public static JsaFugoImpl CreateKyo(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateKei(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateGin(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateKin(Move move, ISky kWrap, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateOh(Move move, ISky copy_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateHisya(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateKaku(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateRyu(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateUma(Move move, ISky src_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateTokin(Move move, ISky kWrap, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateNariKyo(Move move, ISky kWrap, KwLogger errH)
        {
            MigiHidari migiHidari;
            AgaruHiku agaruHiku;
            NariNarazu nari;
        ...
        public static JsaFugoImpl CreateNariKei(Move move, ISky kWrap, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateNariGin(Move move, ISky kWrap, KwLogger errH)
        {
            JsaFugoImpl fugo;
        ...
        public static JsaFugoImpl CreateErrorKoma(Move move, ISky copy_Sky, KwLogger errH)
        {
            JsaFugoImpl fugo;
