...
namespace Grayscale.A210KnowNingen.B600UtilSky.C500Util
{
    public abstract class Util_Sky307
    {
        ...
        public static SfenstringImpl ExportSfen(Playerside psideA, ISky positionA, KwLogger errH)
        {
        ...
        public static SfenstringImpl ExportSfen_ForDebug(
            Playerside psideA, ISky positionA, bool psideIsBlack, KwLogger logger)
        {
            return new SfenstringImpl("sfen " + Util_StartposExporter.ToSfenstring(
