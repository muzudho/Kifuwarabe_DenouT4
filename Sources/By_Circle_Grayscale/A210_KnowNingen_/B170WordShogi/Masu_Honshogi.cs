...
namespace Grayscale.A210KnowNingen.B170WordShogi.C250Masu
{
    ...
    public class Masu_Honshogi
    {
        ...
        /// 集合論の要素ディクショナリー。
        /// </summary>
        private static Dictionary<ulong, INewBasho> bitfieldBashoDictionary;
        ...
        {
            Masu_Honshogi.bitfieldBashoDictionary = new Dictionary<ulong, INewBasho>();
        ...
        public static INewBasho Query_Basho(int masuNumber)
        {
        ...
        public static INewBasho Query_Basho(ulong bitfield)
        {
            INewBasho basho;
        ...
        public static bool Basho_Equals(object obj1, object obj2)
        {
            ...
            return ((INewBasho)obj2).MasuNumber == ((INewBasho)obj1).MasuNumber;
        }
        ...
        public static bool IsErrorBasho(SyElement masu)
        {
            ...
            if (Masu_Honshogi.nError == ((INewBasho)masu).MasuNumber)
            {
                result = true;
            }
            else
