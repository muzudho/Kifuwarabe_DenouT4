    ...
    public abstract class ConvMove
    {
        ...
        public static string ToSfen(Move move)
        {
            ...
            try
            {
                ...
                {
                    sb.Append(ConvMove.KIFU_TREE_LOG_ROOT_FOLDER);
                    goto gt_EndMethod;
                }
        ...
        {
            string moveSfen = ConvMove.ToSfen(move);
        ...
        public static SyElement ToSrcMasu(Move move)
        {
            ...
            {
                // 打なら
                if (Playerside.P1 == ConvMove.ToPlayerside(move))
                {
                    okiba = Okiba.Sente_Komadai;
                }
                else if (Playerside.P2 == ConvMove.ToPlayerside(move))
                {
        ...
        public static Komasyurui14 ToDstKomasyurui(Move move)
        {
            ...
            bool promotion = ConvMove.ToPromotion(move);
        ...
        */
        ...
        public static string ToLog(Move move)
        {
            ...
            // 手番
            Playerside playersideB = ConvMove.ToPlayerside(move);
            ...
            // 至
            SyElement dstMasuB = ConvMove.ToDstMasu(move);
            sb.Append(" dst=");
            sb.Append(Conv_Masu.ToBanjoArabiaAndKanji_FromMasu(dstMasuB));

            // 移動した駒の種類
            Komasyurui14 srcKomasyuruiB = ConvMove.ToSrcKomasyurui(move);
            sb.Append(" srcKs=");
            sb.Append(Util_Komasyurui14.KanjiIchimoji[(int)srcKomasyuruiB]);
            Komasyurui14 dstKomasyuruiB = ConvMove.ToDstKomasyurui(move);
            sb.Append(" dstKs=");
            sb.Append(Util_Komasyurui14.KanjiIchimoji[(int)dstKomasyuruiB]);

            // 取った駒の種類
            Komasyurui14 capturedB = ConvMove.ToCaptured(move);
            sb.Append(" captured=");
