...
namespace Grayscale.A210KnowNingen.B670_ConvKyokume.C500Converter
{
    public abstract class Conv_KifuNode
    {
        ...
        /// <returns></returns>
        public static RO_Kyokumen1_ForFormat ToRO_Kyokumen1(ISky src_Sky, KwLogger errH)
        {
        ...
        /// <param name="errH"></param>
        /// <returns></returns>
        public static string ToSfenstring(ISky src_Sky, Playerside pside, KwLogger errH)
        {
