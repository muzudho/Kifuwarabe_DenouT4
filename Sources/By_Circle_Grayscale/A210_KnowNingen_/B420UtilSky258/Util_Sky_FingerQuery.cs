...
namespace Grayscale.A210KnowNingen.B420UtilSky258.C500UtilSky
{
    ...
    public abstract class Util_Sky_FingerQuery
    {
        ...
        public static Finger InBanjoMasuNow(ISky src_Sky, Playerside pside, SyElement masu, KwLogger errH)
        {
        ...
        public static Finger InOkibaSyuruiNow_IgnoreCase(ISky positionA, Okiba okiba, Komasyurui14 komasyurui, KwLogger errH)
        {
        ...
        /// <param name="uc_Main">メインパネル</param>
        /// <returns>駒。無ければヌル。</returns>
        public static Finger InMasuNow_FilteringBanjo(ISky positionA, Playerside pside, SyElement masu, KwLogger logger)
        {
            Finger foundKoma = Fingers.Error_1;
