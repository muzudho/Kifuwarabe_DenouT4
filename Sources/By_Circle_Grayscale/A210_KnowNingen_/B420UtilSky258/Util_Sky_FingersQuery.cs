...
namespace Grayscale.A210KnowNingen.B420UtilSky258.C500UtilSky
{
    ...
    public abstract class Util_Sky_FingersQuery
    {
        ...
        /// <returns></returns>
        public static Fingers InKomasyuruiNow(ISky src_Sky, Komasyurui14 syurui, KwLogger errH)
        {
        ...
        /// <param name="logTag">ログ名</param>
        /// <returns>スプライト番号。なければエラー番号。</returns>
        public static Fingers InMasuNow_New(ISky positionA, Move move, KwLogger logger)
        {
        ...
        */
        ...
        /// <param name="okiba"></param>
        /// <returns></returns>
        public static Fingers InOkibaNow(ISky src_Sky, Okiba okiba, KwLogger errH)
        {
            Fingers komas = new Fingers();
        ...
        /// <param name="hKomas"></param>
        /// <returns></returns>
        public static Fingers InPsideNow(ISky src_Sky, Playerside pside, KwLogger errH)
        {
            Fingers fingers = new Fingers();
