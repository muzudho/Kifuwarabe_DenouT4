...
namespace Grayscale.Kifuwaragyoku.UseCases.Features
{
    ...
    /// 二駒関係ＰＰで、Ｐ１が盤上の駒のもの。
    /// </summary>
    public abstract class FormatFeatureVectorPpP1Banjo
    {
        ...
        public static string Format_PP_P1Banjo(FeatureVector fv, string title, int p1_base)
        {
            ...
            //----------------------------------------
            {
                ...
                {
                    sb.Append(FormatFeatureVectorPpP1Banjo.Format_NestedShogiban_P1Banjo(fv, p1_base, p2Item));
                }
            }
            ...
            //----------------------------------------
            {
                ...
                {
                    // サンプルで作るだけ
                    sb.Append(FormatFeatureVectorPpP1Banjo.Format_SingleShogiban_P1Banjo(fv, p1_base, p2List[moti]));
                }
            }
