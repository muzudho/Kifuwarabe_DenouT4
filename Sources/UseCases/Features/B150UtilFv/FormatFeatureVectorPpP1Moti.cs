...
namespace Grayscale.Kifuwaragyoku.UseCases.Features
{
    ...
    /// 二駒関係ＰＰで、Ｐ１が持ち駒のもの。
    /// </summary>
    public abstract class FormatFeatureVectorPpP1Moti
    {
        ...
        public static string Format_PP_P1_Moti19Mai(IFeatureVector fv, string title, int p1_base_motiFu)
        {
            ...
            int p1MaisuLength = 19;
            {
                ...
                {
                    // サンプルで作るだけ
                    sb.Append(FormatFeatureVectorPpP1Moti.Format_MaisuList(fv, p1_base_motiFu, p1MaisuLength, p2List[moti]));
                }
            }
        ...
        public static string Format_PP_P1Moti_5Mai(IFeatureVector fv, string title, int p1Koumoku)
        {
            ...
            //----------------------------------------
            {
                ...
                {
                    // サンプルで作るだけ
                    sb.Append(FormatFeatureVectorPpP1Moti.Format_MaisuList(fv, p1Koumoku, p1MaisuLength, p2List[moti]));
                }
            }
