...
{
    public class EngineOptionStringImpl : IEngineOptionString
    {
        public EngineOptionStringImpl()
        {
            this.m_value_ = "";
            this.m_default_ = "";
        }
        ...
        public EngineOptionStringImpl(string value)
        {
            this.m_value_ = value;
            this.m_default_ = value;
        }

        public EngineOptionStringImpl(string value, string defaultValue)
        {
            this.m_value_ = value;
